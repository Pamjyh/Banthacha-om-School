...
│   └── external_schema.sql ← ✅ NEW — ต้องรันใน Supabase SQL Editor ก่อนใช้หน้าเงินนอก
...
### 🔵 P1 pending: Double-write finance_transaction (toggle + manual ซ้ำกัน)
### 🔵 P1 pending: external_schema.sql ยังต้องรันในโปรเจกต์ใหม่
### 🔵 Code.gs (ระบบออมทรัพย์) — ยังไม่แก้ SEC-1/PERF-2
### 🔵 งานที่ผู้ใช้จะแจ้งในแชทถัดไป

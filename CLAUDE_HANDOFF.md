...
| ทุกระบบ | **แผนย้ายบัญชีโรงเรียน** — ออมทรัพย์+ค่ารถ ตรวจละเอียดแล้ว (แชร์ sheet เดียวกัน, แนะนำ transfer ownership) ดู memory `project_gas_migration_plan` — สารบัญ/LINE bot/GitHub ยังไม่ตรวจละเอียด | 🟡 planning |
